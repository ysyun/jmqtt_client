...
public class MQTTClientTest implements MqttCallback {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MQTTClientTest sampleClient = new MQTTClientTest(url,clientId,quietMode);
	 ...
	 */
    public MQTTClientTest(String brokerUrl, String clientId, boolean quietMode) throws MqttException {
