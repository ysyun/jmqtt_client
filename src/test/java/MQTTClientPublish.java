...
public class MQTTClientPublish implements MqttCallback {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MQTTClientPublish sampleClient = new MQTTClientPublish(url,clientId,quietMode);
	 ...
	 */
    public MQTTClientPublish(String brokerUrl, String clientId, boolean quietMode) throws MqttException {
